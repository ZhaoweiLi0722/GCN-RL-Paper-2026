"""Detached launcher for the locked Stage F1 online DDPG campaign."""
...
def main() -> None:
    ...
    command = [
        sys.executable,
        "-m",
        "evaluation.run_patient_indexed_specimen_routing_ddpg_online_paired_advantage",
        "--expected-commit",
    ...
    print(f"Stage F1 detached PID: {process.pid}", flush=True)
