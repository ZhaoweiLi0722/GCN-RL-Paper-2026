"""Tests for checkpoint-compatible conservative flat AFR-TD3."""
...
class ConservativeFlatResidualTD3Tests(unittest.TestCase):
    def setUp(self) -> None:
        try:
        ...
        if torch is None:  # pragma: no cover
            self.skipTest("torch not available")
        self.agent_cls = ConservativeFlatResidualTD3Agent
        self.torch = torch
