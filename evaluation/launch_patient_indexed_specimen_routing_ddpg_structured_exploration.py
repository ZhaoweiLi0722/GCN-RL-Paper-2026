"""Detached launcher for the locked Stage C3 DDPG campaign."""
...
def main() -> None:
    ...
    command = [
        sys.executable,
        "-m",
        "evaluation.run_patient_indexed_specimen_routing_ddpg_structured_exploration",
        "--expected-commit",
    ...
    print(f"Stage C3 detached PID: {process.pid}", flush=True)
