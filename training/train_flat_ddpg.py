"""Train the flat-state DDPG baseline."""
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/flat_ddpg.yaml")
    ...
    write_rows(rows, config.get("result_csv_path", "results/flat_ddpg_training.csv"))
    save_config_snapshot(config, config.get("config_snapshot_path", "results/flat_ddpg_config_snapshot.json"))
