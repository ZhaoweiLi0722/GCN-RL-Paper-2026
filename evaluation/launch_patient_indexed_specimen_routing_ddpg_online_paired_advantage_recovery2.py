"""Detached launcher for the evaluation-only Stage F1 Recovery 2."""
...
def main() -> None:
    ...
    command = [
        sys.executable,
        "-m",
        "evaluation.run_patient_indexed_specimen_routing_ddpg_online_paired_advantage_recovery2",
        "--expected-commit",
    ...
    print(f"Stage F1 Recovery 2 detached PID: {process.pid}", flush=True)
